...
async def lifespan(app: FastAPI):
    ...
    # Mechanical stop: shutting the app down is not the user pausing the
    # engine — keep engine_enabled untouched so it auto-starts next boot.
...
async def login_page(request: Request):
    # get_me() performs a real RPC: a client whose cached "authorized" flag
    # outlived a dead auth key must not bounce the user back to "/" forever.
